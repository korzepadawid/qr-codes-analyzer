...
// Source: github.com/korzepadawid/qr-codes-analyzer/cache (interfaces: Cache)
...
import (
	...
	cache "github.com/korzepadawid/qr-codes-analyzer/cache"
	reflect "reflect"
)
...
func (m *MockCache) Set(arg0 *cache.SetParams) error {
	m.ctrl.T.Helper()
