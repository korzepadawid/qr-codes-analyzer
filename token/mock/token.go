...
// Source: github.com/korzepadawid/qr-codes-analyzer/token (interfaces: Maker)
...
func (m *MockMaker) CreateToken(arg0 string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMakerMockRecorder) CreateToken(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateToken", reflect.TypeOf((*MockMaker)(nil).CreateToken), arg0)
}
